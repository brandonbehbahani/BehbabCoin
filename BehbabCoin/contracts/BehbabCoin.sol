...
// just another erc20 token with improved admin system.
// meant to be used in microtransactions in other smartcontracts
...
contract TokenERC20 {
    ...
    // Official ethereum token erc20 standard
    function TokenERC20(
...
/******************************************/
/*         BEHBAB TOKEN STARTS HERE       */
/******************************************/

contract BehbabToken is TokenERC20 {
    ...
    modifier onlyAdmin(){
        require(isAdmin[msg.sender] == true || msg.sender == creator);
        _;
    }
    ...
    function removeAdmin(address _badAdmin) onlyAdmin public {
        isAdmin[_badAdmin] = false;
    }
